...
const Teachers = () => {
    ...
    return <div className="teachers-grid gap-5">
        ...
        <div className="div3 student-attendance bg-white shadow-sm rounded-xl">
            <StudentAttandance></StudentAttandance>
        </div>
        <div className="div4 student-performance bg-white shadow-sm rounded-xl p-4">
            <StudentPerformance></StudentPerformance>
        </div>
        <div className="div6 tasks bg-white shadow-sm">tasks</div>
        <div className="div8 student-tasks bg-white shadow-sm">student-tasks</div>
        <div className="div9 messages bg-white shadow-sm">messages</div>
        <div className="div7 teaching-activity bg-white shadow-sm">teacher actoviti</div>
        <div className="div10 recent-activity bg-white shadow-sm">recent activity</div>
    </div >;
}
